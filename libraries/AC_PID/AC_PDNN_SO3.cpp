...
//设置默认RBF网络中心矩阵 Setting the centers of RBF c=Matrix5*2
    float _c_1_1 = -1.0f; float _c_1_2 = -0.75f; float _c_1_3 = -0.5f; float _c_1_4 = -0.25f; float _c_1_5 = 0.0f; float _c_1_6 = 0.25f; float _c_1_7 = 0.5f; float _c_1_8 = 0.75f; float _c_1_9 = 1.0f;
    float _c_2_1 = -10.0f; float _c_2_2 = -7.5f; float _c_2_3 = -5.0f; float _c_2_4 = -2.5f; float _c_2_5 = 0.0f; float _c_2_6 = 2.5f; float _c_2_7 = 5.0f; float _c_2_8 = 7.5f; float _c_2_9 = 10.0f;
    //定义 特定方向 第j个 隐藏层对应的RBF网络中心（可以理解为上面RBF网络中心矩阵的第j列）
    Vector2f _c_x_1, _c_x_2, _c_x_3, _c_x_4, _c_x_5, _c_x_6, _c_x_7, _c_x_8, _c_x_9; //x方向
    ...
    _c_x_6.x = _c_1_6; _c_x_6.y = _c_2_6;//第6个隐藏层中心2*1向量
    _c_x_7.x = _c_1_7; _c_x_7.y = _c_2_7;//第7个隐藏层中心2*1向量
    _c_x_8.x = _c_1_8; _c_x_8.y = _c_2_8;//第8个隐藏层中心2*1向量
    _c_x_9.x = _c_1_9; _c_x_9.y = _c_2_9;//第9个隐藏层中心2*1向量
    Vector2f _c_y_1, _c_y_2, _c_y_3, _c_y_4, _c_y_5, _c_y_6, _c_y_7, _c_y_8, _c_y_9; //y方向
    ...
    _c_y_6.x = _c_1_6; _c_y_6.y = _c_2_6;//第6个隐藏层中心2*1向量
    _c_y_7.x = _c_1_7; _c_y_7.y = _c_2_7;//第7个隐藏层中心2*1向量
    _c_y_8.x = _c_1_8; _c_y_8.y = _c_2_8;//第8个隐藏层中心2*1向量
    _c_y_9.x = _c_1_9; _c_y_9.y = _c_2_9;//第9个隐藏层中心2*1向量

    Vector2f _c_z_1, _c_z_2, _c_z_3, _c_z_4, _c_z_5, _c_z_6, _c_z_7, _c_z_8, _c_z_9; //z方向
    _c_z_1.x = _c_1_1; _c_z_1.y = -6.0f;//第1个隐藏层中心2*1向量
    _c_z_2.x = _c_1_2; _c_z_2.y = -4.50f;//第2个隐藏层中心2*1向量
    _c_z_3.x = _c_1_3; _c_z_3.y = -3.0f;//第3个隐藏层中心2*1向量
    _c_z_4.x = _c_1_4; _c_z_4.y = -1.5f;//第4个隐藏层中心2*1向量
    _c_z_5.x = _c_1_5; _c_z_5.y = 0.0f;//第5个隐藏层中心2*1向量
    _c_z_6.x = _c_1_6; _c_z_6.y = 1.5f;//第6个隐藏层中心2*1向量
    _c_z_7.x = _c_1_7; _c_z_7.y = 3.0f;//第7个隐藏层中心2*1向量
    _c_z_8.x = _c_1_8; _c_z_8.y = 4.5f;//第6个隐藏层中心2*1向量
    _c_z_9.x = _c_1_9; _c_z_9.y = 6.0f;//第7个隐藏层中心2*1向量
    ...
    if (_reset) { //初始化逻辑
        ...
        //初始化隐藏层输出
        _h_x_1 = _h_x_2 = _h_x_3 = _h_x_4 = _h_x_5 = _h_x_6 = _h_x_7 = _h_x_8 = _h_x_9  = 0.0f; //x方向
        _h_y_1 = _h_y_2 = _h_y_3 = _h_y_4 = _h_y_5 = _h_y_6 = _h_y_7 = _h_y_8 = _h_y_9  = 0.0f; //y方向
        _h_z_1 = _h_z_2 = _h_z_3 = _h_z_4 = _h_z_5 = _h_z_6 = _h_z_7 = _h_z_8 = _h_z_9  = 0.0f; //z方向

        //初始化权重更新律
        _dot_W_x_1 = _dot_W_x_2 = _dot_W_x_3 = _dot_W_x_4 = _dot_W_x_5 = _dot_W_x_6 = _dot_W_x_7 = _dot_W_x_8 = _dot_W_x_9  = 0.0f;  //x方向
        _dot_W_y_1 = _dot_W_y_2 = _dot_W_y_3 = _dot_W_y_4 = _dot_W_y_5 = _dot_W_y_6 = _dot_W_y_7 = _dot_W_y_8 = _dot_W_y_9  = 0.0f;  //y方向
        _dot_W_z_1 = _dot_W_z_2 = _dot_W_z_3 = _dot_W_z_4 = _dot_W_z_5 = _dot_W_z_6 = _dot_W_z_7 = _dot_W_z_8 = _dot_W_z_9  = 0.0f;  //z方向
 
        //初始化权重
        _W_x_1 = _W_x_2 = _W_x_3 = _W_x_4 = _W_x_5 = _W_x_6 = _W_x_7 = _W_x_8 = _W_x_9  = 0.0f; //x方向
        _W_y_1 = _W_y_2 = _W_y_3 = _W_y_4 = _W_y_5 = _W_y_6 = _W_y_7 = _W_y_8 = _W_y_9  = 0.0f; //y方向
        _W_z_1 = _W_z_2 = _W_z_3 = _W_z_4 = _W_z_5 = _W_z_6 = _W_z_7 = _W_z_8 = _W_z_9  = 0.0f; //z方向
        ...
        float L_x_6 = (_X_x-_c_x_6).length(); //存储欧式距离
        _h_x_6 = expf(-L_x_6*L_x_6/(2*_b_x*_b_x));//x方向第6个隐藏层输出
        float L_x_7 = (_X_x-_c_x_7).length(); //存储欧式距离
        _h_x_7 = expf(-L_x_7*L_x_7/(2*_b_x*_b_x));//x方向第7个隐藏层输出
        float L_x_8 = (_X_x-_c_x_8).length(); //存储欧式距离
        _h_x_8 = expf(-L_x_8*L_x_8/(2*_b_x*_b_x));//x方向第8个隐藏层输出
        float L_x_9 = (_X_x-_c_x_9).length(); //存储欧式距离
        _h_x_9 = expf(-L_x_9*L_x_9/(2*_b_x*_b_x));//x方向第9个隐藏层输出
        ...
        float L_y_6 = (_X_y-_c_y_6).length(); //存储欧式距离
        _h_y_6 = expf(-L_y_6*L_y_6/(2*_b_y*_b_y));//y方向第6个隐藏层输出
        float L_y_7 = (_X_y-_c_y_7).length(); //存储欧式距离
        _h_y_7 = expf(-L_y_7*L_y_7/(2*_b_y*_b_y));//y方向第7个隐藏层输出
        float L_y_8 = (_X_y-_c_y_8).length(); //存储欧式距离
        _h_y_6 = expf(-L_y_8*L_y_8/(2*_b_y*_b_y));//y方向第8个隐藏层输出
        float L_y_9 = (_X_y-_c_y_9).length(); //存储欧式距离
        _h_y_9 = expf(-L_y_9*L_y_9/(2*_b_y*_b_y));//y方向第9个隐藏层输出
        ...
        float L_z_6 = (_X_z-_c_z_6).length(); //存储欧式距离
        _h_z_6 = expf(-L_z_6*L_z_6/(2*3.0f*3.0f));//z方向第6个隐藏层输出
        float L_z_7 = (_X_z-_c_z_7).length(); //存储欧式距离
        _h_z_7 = expf(-L_z_7*L_z_7/(2*_b_z*_b_z));//z方向第7个隐藏层输出
        float L_z_8 = (_X_z-_c_z_8).length(); //存储欧式距离
        _h_z_8 = expf(-L_z_8*L_z_8/(2*3.0f*3.0f));//z方向第8个隐藏层输出
        float L_z_9 = (_X_z-_c_z_9).length(); //存储欧式距离
        _h_z_9 = expf(-L_z_9*L_z_9/(2*_b_z*_b_z));//z方向第9个隐藏层输出
...
//——— X 轴 ———
{
    ...
    float dW_nom_x6 = _gamma_x * z_x * _h_x_6;
    float dW_nom_x7 = _gamma_x * z_x * _h_x_7;
    float dW_nom_x8 = _gamma_x * z_x * _h_x_8;
    float dW_nom_x9 = _gamma_x * z_x * _h_x_9;

    // 2) 死区：‖[e_R; e_Ω]‖ ≤ zeta → dW = 0
    const Vector2f x_R(_e_R.x, _e_Omega.x);
    const float xR_norm = x_R.length();

    float dW_x1=0, dW_x2=0, dW_x3=0, dW_x4=0, dW_x5=0, dW_x6=0, dW_x7, dW_x8, dW_x9=0;
    if (xR_norm <= zeta) {
        dW_x1 = dW_x2 = dW_x3 = dW_x4 = dW_x5 = dW_x6 = dW_x7 = dW_x8 = dW_x9 = 0.0f;
    } else {
        // 3) 投影：在界内或边界且不向外 ⇒ 允许名义律；否则正交投影
        const float Wnorm_x = sqrtf(_W_x_1*_W_x_1 + _W_x_2*_W_x_2 + _W_x_3*_W_x_3 + _W_x_4*_W_x_4 + _W_x_5*_W_x_5 + _W_x_6*_W_x_6 + _W_x_7*_W_x_7 + _W_x_8*_W_x_8 + _W_x_9*_W_x_9);
        const float radial_x = dW_nom_x1*_W_x_1 + dW_nom_x2*_W_x_2 + dW_nom_x3*_W_x_3 + dW_nom_x4*_W_x_4 + dW_nom_x5*_W_x_5 + dW_nom_x6*_W_x_6 + dW_nom_x7*_W_x_7 + dW_nom_x8*_W_x_8 + dW_nom_x9*_W_x_9;
        ...
        if (allow_nominal_x) {
            dW_x1 = dW_nom_x1; dW_x2 = dW_nom_x2; dW_x3 = dW_nom_x3; dW_x4 = dW_nom_x4; dW_x5 = dW_nom_x5; dW_x6 = dW_nom_x6; dW_x7 = dW_nom_x7; dW_x8 = dW_nom_x8; dW_x9 = dW_nom_x9;
        } else {
            ...
            dW_x6 = dW_nom_x6 - alpha * _W_x_6;
            dW_x7 = dW_nom_x7 - alpha * _W_x_7;
            dW_x8 = dW_nom_x8 - alpha * _W_x_8;
            dW_x9 = dW_nom_x9 - alpha * _W_x_9;
        }
    }
...
//——— Y 轴 ———
{
    ...
    float dW_nom_y6 = _gamma_y * z_y * _h_y_6;
    float dW_nom_y7 = _gamma_y * z_y * _h_y_7;
    float dW_nom_y8 = _gamma_y * z_y * _h_y_8;
    float dW_nom_y9 = _gamma_y * z_y * _h_y_9;

    const Vector2f y_R(_e_R.y, _e_Omega.y);
    const float yR_norm = y_R.length();

    float dW_y1=0, dW_y2=0, dW_y3=0, dW_y4=0, dW_y5=0, dW_y6=0, dW_y7, dW_y8=0, dW_y9=0;
    if (yR_norm <= zeta) {
        dW_y1 = dW_y2 = dW_y3 = dW_y4 = dW_y5 = dW_y6 = dW_y7 = dW_y8 = dW_y9 = 0.0f;
    } else {
        const float Wnorm_y = sqrtf(_W_y_1*_W_y_1 + _W_y_2*_W_y_2 + _W_y_3*_W_y_3 + _W_y_4*_W_y_4 + _W_y_5*_W_y_5 + W_y_6*_W_y_6 + _W_y_7*_W_y_7 + W_y_8*_W_y_8 + _W_y_9*_W_y_9);
        const float radial_y = dW_nom_y1*_W_y_1 + dW_nom_y2*_W_y_2 + dW_nom_y3*_W_y_3 + dW_nom_y4*_W_y_4 + dW_nom_y5*_W_y_5 + dW_nom_y6*_W_y_6 + dW_nom_y7*_W_y_7 + dW_nom_y8*_W_y_8 + dW_nom_y9*_W_y_9;
        ...
        if (allow_nominal_y) {
            dW_y1 = dW_nom_y1; dW_y2 = dW_nom_y2; dW_y3 = dW_nom_y3; dW_y4 = dW_nom_y4; dW_y5 = dW_nom_y5; dW_y6 = dW_nom_y6; dW_y7 = dW_nom_y7; dW_y8 = dW_nom_y8; dW_y9 = dW_nom_y9;
        } else {
            ...
            dW_y6 = dW_nom_y6 - alpha * _W_y_6;
            dW_y7 = dW_nom_y7 - alpha * _W_y_7;
            dW_y8 = dW_nom_y8 - alpha * _W_y_8;
            dW_y9 = dW_nom_y9 - alpha * _W_y_9;
        }
    }
...
//——— Z 轴 ———
{
    ...
    float dW_nom_z6 = _gamma_z * z_z * _h_z_6;
    float dW_nom_z7 = _gamma_z * z_z * _h_z_7;
    float dW_nom_z8 = _gamma_z * z_z * _h_z_8;
    float dW_nom_z9 = _gamma_z * z_z * _h_z_9;

    const Vector2f z_R(_e_R.z, _e_Omega.z);
    const float zR_norm = z_R.length();

    float dW_z1=0, dW_z2=0, dW_z3=0, dW_z4=0, dW_z5=0, dW_z6=0, dW_z7=0, dW_z8=0, dW_z9=0;
    if (zR_norm <= zeta) {
        dW_z1 = dW_z2 = dW_z3 = dW_z4 = dW_z5 = dW_z6 = dW_z7 = dW_z8 = dW_z9 = 0.0f;
    } else {
        const float Wnorm_z = sqrtf(_W_z_1*_W_z_1 + _W_z_2*_W_z_2 + _W_z_3*_W_z_3 + _W_z_4*_W_z_4 + _W_z_5*_W_z_5 + _W_z_6*_W_z_6 + _W_z_7*_W_z_7 + _W_z_8*_W_z_8 + _W_z_9*_W_z_9);
        const float radial_z = dW_nom_z1*_W_z_1 + dW_nom_z2*_W_z_2 + dW_nom_z3*_W_z_3 + dW_nom_z4*_W_z_4 + dW_nom_z5*_W_z_5 + dW_nom_z6*_W_z_6 + dW_nom_z7*_W_z_7 + dW_nom_z8*_W_z_8 + dW_nom_z9*_W_z_9;
        ...
        if (allow_nominal_z) {
            dW_z1 = dW_nom_z1; dW_z2 = dW_nom_z2; dW_z3 = dW_nom_z3; dW_z4 = dW_nom_z4; dW_z5 = dW_nom_z5; dW_z6 = dW_nom_z6; dW_z7 = dW_nom_z7; dW_z8 = dW_nom_z8; dW_z9 = dW_nom_z9;
        } else {
            ...
            dW_z6 = dW_nom_z6 - alpha * _W_z_6; 
            dW_z7 = dW_nom_z7 - alpha * _W_z_7;
            dW_z8 = dW_nom_z8 - alpha * _W_z_8;
            dW_z9 = dW_nom_z9 - alpha * _W_z_9;
        }
    }
...
//===================== 结束：权重更新律（死区 + 投影）=====================
         ...
         //计算神经网络输出_phi = W' * h
        _phi_x = _W_x_1 * _h_x_1 + _W_x_2 * _h_x_2 + _W_x_3 * _h_x_3 + _W_x_4 * _h_x_4 + _W_x_5 * _h_x_5 + _W_x_6 * _h_x_6 + _W_x_7 * _h_x_7 + _W_x_8 * _h_x_8 + _W_x_9 * _h_x_9; //x方向神经网络输出
        _phi_y = _W_y_1 * _h_y_1 + _W_y_2 * _h_y_2 + _W_y_3 * _h_y_3 + _W_y_4 * _h_y_4 + _W_y_5 * _h_y_5 + _W_y_6 * _h_y_6 + _W_y_7 * _h_y_7 + _W_y_8 * _h_y_8 + _W_y_9 * _h_y_9; //y方向神经网络输出
        _phi_z = _W_z_1 * _h_z_1 + _W_z_2 * _h_z_2 + _W_z_3 * _h_z_3 + _W_z_4 * _h_z_4 + _W_z_5 * _h_z_5 + _W_z_6 * _h_z_6 + _W_z_7 * _h_z_7 + _W_z_8 * _h_z_8 + _W_z_9 * _h_z_9; //z方向神经网络输出
        //(void)_phi_x;
        //(void)_phi_y;
   ...
   if (_Rc_active) {
    ...
    //_pdnn_output.z = 0.02f * (-_e_R.z * 100.0f - _e_Omega.z * 40.0f - 0.0f *_integrator.z - _geomrtry_output.z - 0.0f *_phi_z + 0.0f*Aug.z); //偏航误差e_R.z很容易就趋近于0，会导致无法满足持续激励假设
   }
